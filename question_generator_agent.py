...
# write a class for the test case
...
# json_string_data = json.dumps(json_data) # this is to serialize the json data

# # design a prompt
# initial_prompt = ""
# with open("prompt_examples.txt", "r" , encoding="utf-8") as file:
#     initial_prompt = file.read()
#     print(initial_prompt)
#     print(f"\n\n the type is {type(initial_prompt)}")

# final_prompt = PromptTemplate(
#     input_variables=["json_input"],
#      template=initial_prompt)

# formatted_prompt = final_prompt.format(json_input=json_string_data)


# trying gemini flash for question generation
...
# bind thisllm with the pydantic class
...
def generate_gemini_question(json_string_data):
...
# print(f"gemini generated question is: \n\n\n {gemini_response}")